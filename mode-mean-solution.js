...
function modemean(array) {
  ...
  if(!array.length) return 'Passed an empty array';
...
function mode(array) {
  ...
  // keep track of the most occurrences count
  let max = -Infinity;
  // keep track of the largest value with the most occurrences
  let mode = -Infinity;
  ...
  for(let num in modes) {
    ...
    // if we have an equal number of this one and our max, update max to whichever is larger
